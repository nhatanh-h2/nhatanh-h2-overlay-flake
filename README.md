  ...
  outputs =
    ...
    flake-utils.lib.eachDefaultSystem (
      ...
      in
      {
        ...
        # devShells.default = h2-overlay.devShells.${system}.goShell.overrideAttrs (old: { buildInputs = old.buildInputs ++ [ pkgs.cachix ]; });
      }
    );
}
```
